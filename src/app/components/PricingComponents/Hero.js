...
import { useGetAllDataQuotationQuery, useGetServiceQuery, useGetServiceTypeQuery } from "@/app/services/quotation";
...
const plans = [
    {
        features: [
            {
                text: "A Detailed Document",
                subFeatures: [
                    "Requirement Outlines (Before Start your any Research Document Work)",
                ],
            },
            {
                text: "Third-party Review Reports",
                subFeatures: [
                    "Plagiarism Report (Turnitin or Drillbit)",
                ],
            },
            "Discussion with Domain Expert before and after the Document",
        ],
        bgClass: "bg-transparent",
        textClass: "text-[#002631]",
        buttonBg: "bg-transparent hover:bg-[#002631] hover:text-white",
    },
    {
        features: [
            {
        ...
        bgClass: "bg-[#064454] border-2 text-black px-2 rounded-md",
        textClass: "text-white",
        buttonBg: "bg-[#002631] hover:bg-white hover:text-[#002631]",
    },
    {
        buttonLabels: ["Start a free trial", "Contact Sales"],
        features: [
            {
                text: "A Detailed Document",
                subFeatures: [
    ...
    {
        features: [
            "A detailed document with all standard guidelines.",
            "Support across all stages of your research, from problem definition, proposal, and process to pathway of acceptance.",
            "Third-party reports (Turnitin and Grammarly)",
            "Support across all stages of your research, from problem definition, proposal, and process to pathway of acceptance.",
        ],
        bgClass: "bg-[#064454] border-2 text-black px-2 rounded-md",
        textClass: "text-white",
        ...
        features: [
            {
                text: "A Detailed Document",
                subFeatures: [
                    "Document Review Report (if you have prepared the work)",
                    "Support across all stages of your research, from problem definition, proposal, and process to pathway of acceptance.",
...
const Hero = () => {
    ...
    const [serviceMethodPrice, setServiceMethodPrice] = useState([]);

    const { data, error, isLoading } = useGetServiceTypeQuery();    
    ...
    useEffect(() => {
        ...
        setServiceMethods(
            data.map(service => service.Method || []) || []
        );

        setServiceMethodPrice(
            data.map(service =>
