    ...
    <div className="w-full pt-28 md:pt-24 lg:pt-36 pb-12 bg-[#002631]">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:ps-32 md:ps-12 ps-6 pe-6">
        ...
        <div className="w-full pe-0">
          <h1 className="lg:leading-[3.4rem] md:leading-[3rem] sm:leading-[2rem] leading-[1.5rem] py-3 text-white lg:text-[40px] md:text-[40px] sm:text-[32px] text-[22px] font-poppins font-medium text-center lg:text-start">
            {data.heading}
          </h1>

          <div
            className="lg:text-[14px] text-[12px] text-[#FFFFFFC7] text-justify font-poppins font-medium leading-7"
